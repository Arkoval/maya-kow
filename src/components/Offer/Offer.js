...
//   };
//   useEffect(() => {
//     animationRight(right, start);
//     animationLeft(left, right);
//     animationRight(right2, left);
//   }, [!isActive]);
...
//         <StyledOfferParagraph>
//           <StyledStrong>
//             Moja spècialitè to trzy grupy kobiet:
//             <StyledList>
//               <li>
//                 - osiągające sukces, odczuwając jednocześnie zmęczenie i
//                 tęsknotę za nieokreślonym
//               </li>
//               <li>- po awansie </li>
//               <li>- pragnące budować uskrzydlone zespoły.</li>
//             </StyledList>
//             To co je łączy, to odwaga tworzenia własnych definicji kobiecości,
//             sukcesu i przywództwa. Odwaga do transformacji. Odwaga do życia
